...
data processing with the data visualization, they could runt the XPDVis server together with the XPD server on
...
In terminal, run the command::
    ...
    run_server xpdvis ~/xpdvis_server.ini
