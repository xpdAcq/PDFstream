...
In the subsections, you will find several servers that you can run for the real time streaming data analysis.
...
Before you start the server, you need to start the proxy first. The proxy is a server that transfer the message
